return {
    ...
    config = function()
        ...
        vim.api.nvim_set_hl(0, 'RenderMarkdownH2Bg', { bg = '#e8e8e8' })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH3Bg', { bg = '#e8e8e8' })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH4Bg', { bg = '#e8e8e8' })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH5Bg', { bg = '#e8e8e8' })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH6Bg', { bg = '#e8e8e8' })
